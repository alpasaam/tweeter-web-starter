...
describe("AppNavbarPresenter", () => {
  ...
  it("tells the view to display an error message and does not tell it to clear the info message, clear the user info or navigate to the login page when logout is not successful", async () => {
